...
public sealed partial class MainWindow : Window
{
    ...
    private void NavView_Loaded(object sender, RoutedEventArgs e)
    {
        ...
        NavView_Navigate(typeof(PlayerList), new EntranceNavigationTransitionInfo());
    }
        ...
        NavigationViewItemInvokedEventArgs args)
    {
        ...
        {
            NavView_Navigate(typeof(SettingsView), args.RecommendedNavigationTransitionInfo, _settingsService);
        }
        else if (args.InvokedItemContainer?.Tag != null)
        {
            var navPageType = Type.GetType(args.InvokedItemContainer.Tag.ToString()!);
            if (navPageType != null) NavView_Navigate(navPageType, args.RecommendedNavigationTransitionInfo);
        }
    }
    ...
    private async void AlwaysOnTopButton_Click(object sender, RoutedEventArgs e)
    {
        if (!isOnTop)
        {
            ...
            isOnTop = true;
            var alwaysontop = OverlappedPresenter.Create();
            ...
            if (preTopPage != typeof(PlayerList))
                NavView_Navigate(typeof(PlayerList), new DrillInNavigationTransitionInfo());
            NavView.PaneDisplayMode = NavigationViewPaneDisplayMode.LeftMinimal;
            var margin = NavView.Margin;
            margin.Top = 0;
            margin.Bottom = -32;
        ...
        else
        {
            ...
            margin.Bottom = 0;
            NavView.Margin = margin;
            var padding = ContentFrame.Margin;
            margin.Top = 0;
            ContentFrame.Margin = margin;
    ...
    private bool TrySetAcrylicBackdrop()
    {
        if (DesktopAcrylicController.IsSupported())
        {
            ...
            m_acrylicController.TintColor = Colors.Black;
    ...
    private void SetAlwaysOnTopTitleBarVisible(bool visible)
    {
        ...
        if (tempPresenter != null) AppWindow.SetPresenter(tempPresenter);
